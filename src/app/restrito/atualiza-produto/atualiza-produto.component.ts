...
export class AtualizaProdutoComponent implements OnInit{
    ...
    constructor(private _produtoService:ProdutoService, private _router: Router, private _activatatedRoute:ActivatedRoute){
      this._activatatedRoute.params.subscribe(params => this.produtoId = params['id']);
    }
  ngOnInit(): void {
    this.listarProduto();
  }
